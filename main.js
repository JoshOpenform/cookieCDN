class Banner {
  ...
  handleConsent() {
    ...
    this.setPrefCookie("all","true",7,1);
    this.hideElement(this.bannerContainer);
    this.hideElement(this.settingsMenu);
  ...
  setPrefCookie(cookieName, agreed, list = false) {
    ...
    this.setCookie('Strictly','true',7);
    this.setCookie('Performance','true',7);
    this.setCookie('Analytics','true',7);
    this.setCookie('Marketing','true',7);
    this.setCookie('Functional','true',7);
  }
